...
/**
 * Servlet implementation class DoLogListController
 */
@WebServlet("/DoLogListController")
public class DoLogListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoLogListController() {
        super();
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		DoLogDao doLogDao = new DoLogDaoImpl();
		try {
			Page page = doLogDao.getPageByLike(Integer.parseInt(request.getParameter("pageNum")) - 1, 8, columnName,
					columnValue);
		...
		request.getRequestDispatcher("/admin/doLog/doLogList.jsp").forward(request, response);
	}
